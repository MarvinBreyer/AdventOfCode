/******************************************************************************
 *  Compilation:  javac AoC.resources.StdIn.java
 *  Execution:    java AoC.resources.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code AoC.resources.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code AoC.resources.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">AoC.resources.StdIn.java</a>
 ...
 *  <pre>
 *  while (!AoC.resources.StdIn.isEmpty()) {
 *      double value = AoC.resources.StdIn.readDouble();
 *      AoC.resources.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (AoC.resources.StdIn.hasNextChar()) {
 *      char c = AoC.resources.StdIn.readChar();
 *      AoC.resources.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (AoC.resources.StdIn.hasNextLine()) {
 *      String line = AoC.resources.StdIn.readLine();
 *      AoC.resources.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = AoC.resources.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code AoC.resources.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code AoC.resources.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code AoC.resources.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code AoC.resources.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code AoC.resources.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code AoC.resources.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code AoC.resources.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code AoC.resources.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code AoC.resources.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to AoC.resources.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to AoC.resources.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to AoC.resources.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to AoC.resources.StdIn
    
    
    // do this once when AoC.resources.StdIn is initialized
    static {
        resync();
    }

    /**
     * If AoC.resources.StdIn changes, use this to reinitialize the scanner.
     */
